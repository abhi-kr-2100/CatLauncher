  ...
  async fn update_cached_releases(
    ...
    task::spawn_blocking(move || {
            ...
            for release in releases {
                let release_id: i64 = release.id as i64;
                ...
                for asset in &release.assets {
                    let asset_id: i64 = asset.id as i64;
