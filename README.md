...
To use the AppImage, download it, and make it executable by running `chmod a+x cat-launcher_0.12.0_amd64.AppImage`, and then run it like you would any other executable.
